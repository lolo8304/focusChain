...
geth --genesis focuschain-genesis.json --datadir focuschainData --networkid 19700105 --port 30301 --rpcapi "eth,net,web3" --rpcport 8101 --rpc --rpcaddr 192.168.2.111 --ipcpath /Users/david/Library/Ethereum/geth.ipc  --identity david --nodiscover --verbosity 5 --preload functions.js console 2>> eth.log